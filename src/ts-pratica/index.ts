...
// Multiplicar (tipagem explícita após inferência)
...
console.log("criarPessoa('Andre Cantador', 38) =", criarPessoa("Andre Cantador", 38));
console.log("descreverCarro(carroTipado) =", descreverCarro(carroTipado));

// ----------------------------------------------------
// Prática: Herança, interfaces e encapsulamento
// ----------------------------------------------------

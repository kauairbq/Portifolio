...
let AuthService = class AuthService {
    ...
    async issueTokens(userId, email, role) {
        ...
        const accessToken = await this.jwt.signAsync({ sub: userId, email, role }, { secret: this.config.get("JWT_ACCESS_SECRET"), expiresIn: accessTtl });
        const refreshToken = await this.jwt.signAsync({ sub: userId, email, role }, { secret: this.config.get("JWT_REFRESH_SECRET"), expiresIn: refreshTtl });

...
var UrlParser = class {
  ...
  parseParens(allowPrimary) {
    ...
    while (!this.consumeOptional(")") && this.remaining.length > 0) {
      ...
      segments[outletName != null ? outletName : PRIMARY_OUTLET] = Object.keys(children).length === 1 && children[PRIMARY_OUTLET] ? children[PRIMARY_OUTLET] : new UrlSegmentGroup([], children);
      this.consumeOptional("//");
    }
    return segments;
  }
...
function tree(oldRoot, oldSegmentGroup, newSegmentGroup, queryParams, fragment, urlSerializer) {
  const qp = {};
  for (const [key, value] of Object.entries(queryParams != null ? queryParams : {})) {
  ...
  if (typeof ngDevMode === "undefined" || ngDevMode) {
    ...
    if (route.redirectTo) {
      ...
      if (route.canMatch || route.canActivate) {
        throw new RuntimeError(4014, "Invalid configuration of route '".concat(fullPath, "': redirectTo and ").concat(route.canMatch ? "canMatch" : "canActivate", " cannot be used together.") + "Redirects happen before guards are executed.");
      }
    }
...
var _RouterOutlet = class _RouterOutlet {
  constructor() {
    ...
    __publicField(this, "routerOutletData", input(...ngDevMode ? [void 0, {
...
function namedOutletsRedirect$1(redirectTo) {
  throw new RuntimeError(4e3, (typeof ngDevMode === "undefined" || ngDevMode) && "Only absolute redirects can have named outlets. redirectTo: '".concat(redirectTo, "'"));
}
function canLoadFails$1(route) {
  throw navigationCancelingError((typeof ngDevMode === "undefined" || ngDevMode) && "Cannot load children because the guard of the route \"path: '".concat(route.path, "'\" returned false"), NavigationCancellationCode.GuardRejected);
}
  ...
  async lineralizeSegments(route, urlTree) {
    ...
    while (true) {
      ...
      if (c.numberOfChildren > 1 || !c.children[PRIMARY_OUTLET]) {
        throw namedOutletsRedirect$1("".concat(route.redirectTo));
      }
...
var Recognizer$1 = class Recognizer {
  ...
  async processSegment(injector, routes, segmentGroup, segments, outlet, allowRedirects, parentRoute) {
    ...
    for (const r of routes) {
      try {
        return await this.processSegmentAgainstRoute((_a2 = r._injector) != null ? _a2 : injector, routes, r, segmentGroup, segments, outlet, allowRedirects, parentRoute);
      } catch (e) {
  ...
  async expandSegmentAgainstRouteUsingRedirect(injector, segmentGroup, routes, route, segments, outlet, parentRoute) {
    ...
    const currentSnapshot = new ActivatedRouteSnapshot(segments, parameters, Object.freeze(__spreadValues({}, this.urlTree.queryParams)), this.urlTree.fragment, getData$1(route), getOutlet(route), (_b2 = (_a2 = route.component) != null ? _a2 : route._loadedComponent) != null ? _b2 : null, route, getResolve$1(route));
  ...
  async matchSegmentAgainstRoute(injector, rawSegment, route, segments, outlet, parentRoute) {
    ...
    if (!(result == null ? void 0 : result.matched)) {
      throw new NoMatch$1(rawSegment);
    }
    ...
    const snapshot = new ActivatedRouteSnapshot(consumedSegments, parameters, Object.freeze(__spreadValues({}, this.urlTree.queryParams)), this.urlTree.fragment, getData$1(route), getOutlet(route), (_d = (_c = route.component) != null ? _c : route._loadedComponent) != null ? _d : null, route, getResolve$1(route));
...
var _NavigationTransitions = class _NavigationTransitions {
  constructor() {
    __publicField(this, "currentNavigation", signal(null, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "currentNavigation"
    } : {}), {
      equal: () => false
    })));
    __publicField(this, "currentTransition", null);
    __publicField(this, "lastSuccessfulNavigation", signal(null, ...ngDevMode ? [{
      debugName: "lastSuccessfulNavigation"
    }] : []));
    __publicField(this, "events", new Subject());
    __publicField(this, "transitionAbortWithErrorSubject", new Subject());
    ...
    return this.transitions.pipe(filter((t) => t !== null), switchMap((overallTransitionState) => {
      ...
      return of(overallTransitionState).pipe(switchMap((t) => {
        ...
        const loadComponents = (route) => {
          var _a2, _b2, _c, _d;
          const loaders2 = [];
          if ((_a2 = route.routeConfig) == null ? void 0 : _a2._loadedComponent) {
            route.component = (_b2 = route.routeConfig) == null ? void 0 : _b2._loadedComponent;
          } else if ((_c = route.routeConfig) == null ? void 0 : _c.loadComponent) {
            const injector = (_d = getClosestRouteInjector(route)) != null ? _d : this.environmentInjector;
  ...
  isUpdatedBrowserUrl() {
    ...
    const targetBrowserUrl = (_a2 = currentNavigation == null ? void 0 : currentNavigation.targetBrowserUrl) != null ? _a2 : currentNavigation == null ? void 0 : currentNavigation.extractedUrl;
    return currentBrowserUrl.toString() !== (targetBrowserUrl == null ? void 0 : targetBrowserUrl.toString()) && !(currentNavigation == null ? void 0 : currentNavigation.extras.skipLocationChange);
  }
};
...
var _Router = class _Router {
  constructor() {
    ...
    __publicField(this, "currentNavigation", this.navigationTransitions.currentNavigation.asReadonly());
  ...
  dispose() {
    ...
    (_a2 = this.nonRouterCurrentEntryChangeSubscription) == null ? void 0 : _a2.unsubscribe();
  ...
  createUrlTree(commands, navigationExtras = {}) {
    ...
    return createUrlTreeFromSegmentGroup(relativeToUrlSegmentGroup, commands, q, f != null ? f : null, this.urlSerializer);
  }
  ...
  parseUrl(url) {
    try {
      ...
      this.console.warn(formatRuntimeError(4018, ngDevMode && "Error parsing URL ".concat(url, ". Falling back to '/' instead. \n") + e));
...
var _RouterLink = class _RouterLink {
  constructor(router, route, tabIndexAttribute, renderer, el, locationStrategy) {
    ...
    __publicField(this, "reactiveHref", signal(null, ...ngDevMode ? [{
    ...
    this.isAnchorElement = tagName === "a" || tagName === "area" || !!(typeof customElements === "object" && ((_d = (_c = (_b2 = customElements.get(tagName)) == null ? void 0 : _b2.observedAttributes) == null ? void 0 : _c.includes) == null ? void 0 : _d.call(_c, "href")));
...
var _RouterLinkActive = class _RouterLinkActive {
  constructor(router, element, renderer, cdr) {
    ...
    __publicField(this, "link", inject(RouterLink, {
      optional: true
    }));
    this.router = router;
...
var _RouterPreloader = class _RouterPreloader {
  ...
  processRoutes(injector, routes) {
    ...
    for (const route of routes) {
      if (route.providers && !route._injector) {
        route._injector = createEnvironmentInjector(route.providers, injector, typeof ngDevMode === "undefined" || ngDevMode ? "Route: ".concat(route.path) : "");
      }
...
var _RouterScroller = class _RouterScroller {
  constructor(urlSerializer, transitions, viewportScroller, zone, options = {}) {
    ...
    __publicField(this, "lastSource", IMPERATIVE_NAVIGATION);
...
var _NavigationStateManager = class _NavigationStateManager extends HistoryStateManager {
  constructor() {
    super(...arguments);
  ...
  registerNonRouterCurrentEntryChangeListener(listener) {
    return this.location.subscribe((event) => {
      var _a2;
      if (event["type"] === "popstate") {
        const state = (_a2 = this.navigation.currentEntry) == null ? void 0 : _a2.getState();
        listener(event["url"], state, "popstate");
      }
    });
  }
};
__publicField(_NavigationStateManager, "ɵfac", /* @__PURE__ */ (() => {
...
__publicField(_NavigationStateManager, "ɵprov", ɵɵdefineInjectable({
  token: _NavigationStateManager,
  factory: _NavigationStateManager.ɵfac,
  providedIn: "root"
}));
var NavigationStateManager = _NavigationStateManager;
(() => {
...
function withPlatformNavigation() {
  const devModeLocationCheck = typeof ngDevMode === "undefined" || ngDevMode ? [provideEnvironmentInitializer(() => {
    ...
    if (!(locationInstance instanceof NavigationAdapterForLocation)) {
      ...
      let message = "'withPlatformNavigation' provides a 'Location' implementation that ensures navigation APIs are consistently used." + " An instance of ".concat(locationConstructorName, " was found instead.");

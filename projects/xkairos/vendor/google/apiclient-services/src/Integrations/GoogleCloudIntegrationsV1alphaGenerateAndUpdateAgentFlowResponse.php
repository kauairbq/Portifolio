...
class_alias(GoogleCloudIntegrationsV1alphaGenerateAndUpdateAgentFlowResponse::class, 'Google_Service_Integrations_GoogleCloudIntegrationsV1alphaGenerateAndUpdateAgentFlowResponse');

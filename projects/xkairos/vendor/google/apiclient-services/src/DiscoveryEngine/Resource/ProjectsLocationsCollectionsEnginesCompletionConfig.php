...
class_alias(ProjectsLocationsCollectionsEnginesCompletionConfig::class, 'Google_Service_DiscoveryEngine_Resource_ProjectsLocationsCollectionsEnginesCompletionConfig');

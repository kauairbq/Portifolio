...
class_alias(ProjectsLocationsDataStoresSiteSearchEngineSitemaps::class, 'Google_Service_DiscoveryEngine_Resource_ProjectsLocationsDataStoresSiteSearchEngineSitemaps');

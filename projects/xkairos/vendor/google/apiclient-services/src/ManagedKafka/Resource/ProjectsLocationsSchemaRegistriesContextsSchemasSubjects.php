...
class_alias(ProjectsLocationsSchemaRegistriesContextsSchemasSubjects::class, 'Google_Service_ManagedKafka_Resource_ProjectsLocationsSchemaRegistriesContextsSchemasSubjects');

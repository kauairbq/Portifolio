...
class_alias(ProjectsLocationsSchemaRegistriesContextsSubjects::class, 'Google_Service_ManagedKafka_Resource_ProjectsLocationsSchemaRegistriesContextsSubjects');

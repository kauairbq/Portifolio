...
## 2️⃣ HERO SECTION (PRIORIDADE MÁXIMA)
...
* 1 CTA primário + 1 secundário (CV)
...
## 5️⃣ PROJETOS – CURADORIA (CRÍTICO)
...
## 6️⃣ PROJETOS – CURADORIA FINAL (DECISÃO ESTRATÉGICA)

### 🥇 Projetos que DEVEM aparecer (Vitrine Premium)
...
### 🥈 Projetos que PODEM aparecer (Vitrine Secundária)
...
### 🗃️ Projetos que NÃO devem aparecer na vitrine
...
## 7️⃣ CARD DE PROJETO – PADRÃO VISUAL
...
## 1️⃣6️⃣ INVENTÁRIO FINAL DE PROJETOS (CONTROLE TOTAL)

> Esta seção serve como **controle mestre**. Todo projeto deve estar **classificado aqui**.
...
## 1️⃣7️⃣ CHECKLIST FINAL DE PUBLICAÇÃO
...
## 1️⃣8️⃣ DEFINIÇÃO DE PRONTO (FINAL)

> O portfólio está **oficialmente pronto** quando:
>
> • Um recrutador entende teu nível em **menos de 10 segundos**
> • Um tech lead identifica **engenharia real** nos projetos
> • O layout transmite **confiança, clareza e maturidade**
